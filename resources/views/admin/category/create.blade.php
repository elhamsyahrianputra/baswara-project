                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="inputName" placeholder="Enter category name ...." name="name" value="{{ old('name') }}"
                                        autocomplete="off" />
                                    @error('name')    
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('description') is-invalid @enderror"
                                        id="inputDescrition" placeholder="Enter category description ...." name="description" value="{{ old('description') }}"
                                        autocomplete="off" />
                                    @error('description')    
                                    <div class="invalid-feedback">
                                        {{ $message }}
