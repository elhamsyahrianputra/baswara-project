                                        ...
                                        .concat(
                                            ...
                                            '<ul class="main_socials d-flex align-items-center">'+
                                                '<li class="main_socials-item">'+
                                                    '<a class="link" href="').concat(instagram[e].textContent, '" target="_blank" rel="noopener noreferrer">'+
                                                        '<i class="icon-instagram icon"></i>'+
                                                    '</a>'+
                                                '</li>'+
                                                '<li class="main_socials-item">'+
                                                    '<a class="link" href="').concat(facebook[e].textContent, '" target="_blank" rel="noopener noreferrer">'+
                                                        '<i class="icon-facebook icon"></i>'+
                                                    '</a>'+
                                                '</li>'+
                                                '<li class="main_socials-item">'+
                                                    '<a class="link" href="').concat(linkedin[e].textContent, '" target="_blank" rel="noopener noreferrer">'+
