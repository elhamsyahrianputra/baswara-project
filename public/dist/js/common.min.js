    ...
    (n.n = (t) => {
        ...
        (() => {
            ...
            we.on(document, "click.bs.collapse.data-api", Je, function (t) {
                ...
                ee(tn);
            const en = "dropdown_navbar",
                nn = "Escape",
                on = "Space",
                sn = "ArrowUp",
                rn = "ArrowDown",
                an = new RegExp("ArrowUp|ArrowDown|Escape"),
                cn = "click.bs.dropdown_navbar.data-api",
                ln = "keydown.bs.dropdown_navbar.data-api",
                un = "show",
                dn = '[data-bs-toggle="dropdown_navbar"]',
                pn = ".dropdown_navbar-menu",
            ...
            class _n extends Ce {
                ...
                show() {
                    ...
                    if (
                        we.trigger(this._element, "show.bs.dropdown_navbar", t)
                            .defaultPrevented
                    )
                        return;
                ...
                _completeHide(t) {
                    we.trigger(this._element, "hide.bs.dropdown_navbar", t)
                        .defaultPrevented ||
                        ("ontouchstart" in document.documentElement &&
                            []
                                .concat(...document.body.children)
                ...
                _selectMenuItem({ key: t, target: e }) {
                    const n = Pe.find(
                        ".dropdown_navbar-menu .dropdown_navbar-item:not(.disabled):not(:disabled)",
                        this._menu
                    ).filter(Yt);
            ...
            we.on(document, ln, dn, _n.dataApiKeydownHandler),
                ...
                we.on(
                    document,
                    "keyup.bs.dropdown_navbar.data-api",
                    _n.clearMenus
                ),
            ...
            const Si = "scrollspy",
                ...
                Di = "dropdown_navbar-item",
                Ii = "active",
                Bi = ".nav-link",
                Mi = ".nav-link, .list-group-item, .dropdown_navbar-item",
                Hi = "position";
            class qi extends Ce {
                constructor(t, e) {
                    super(t),
                ...
                _activate(t) {
                    ...
                    n.classList.add(Ii),
                        n.classList.contains(Di)
                            ? Pe.findOne(
                                  ".dropdown_navbar-toggle",
                                  n.closest(".dropdown_navbar")
                              ).classList.add(Ii)
            ...
            class Ui extends Ce {
                ...
                _transitionComplete(t, e, n) {
                    if (e) {
                        ...
                        const t = Pe.findOne(
                            ":scope > .dropdown_navbar-menu .active",
                            e.parentNode
                        );
                    ...
                    if (
                        ...
                        i && i.classList.contains("dropdown_navbar-menu"))
                    ) {
                        const e = t.closest(".dropdown_navbar");
                        e &&
                            Pe.find(".dropdown_navbar-toggle", e).forEach((t) =>
                                t.classList.add(zi)
                            ),
            ...
            function no() {
                var t = document.querySelectorAll(".dropdown_navbar"),
                    e = document.querySelectorAll(".dropdown_navbar-toggle"),
                    n = document.querySelectorAll(".dropdown_navbar-menu");
                    ...
                    t.forEach(function (t) {
                        t.addEventListener("mouseover", function (t) {
                            var e = this.querySelector(
                                    'a[data-trigger="dropdown_navbar"]'
                                ),
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                !(function (t, e) {
                    ...
                    document.getElementById("signUpTrigger").addEventListener("click", function () {
                            bo(
                                {
                                    html: '<iframe class="read_book--modal" src="' + document.getElementById("book-download").getAttribute("href") + '" frameborder="0"></iframe>',
                                },
